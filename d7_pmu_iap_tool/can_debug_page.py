...
class CanDebugPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        config_row.addWidget(QLabel("USBCANFD-200U · Index 0"))
        config_row.addSpacing(8)
        config_row.addWidget(QLabel("通道"))
        config_row.addWidget(self.channel_input)
        config_row.addWidget(QLabel("仲裁域"))
        config_row.addWidget(self.baudrate_input)
        config_row.addWidget(QLabel("数据域"))
        config_row.addWidget(self.data_baudrate_input)
        config_row.addStretch(1)
        config_row.addWidget(self.dll_button)
        config_row.addWidget(self.open_button)
        config_row.addWidget(self.close_button)
        connection = QVBoxLayout()
        connection.setContentsMargins(18, 12, 18, 12)
        connection.setSpacing(10)
        connection.addLayout(heading)
        connection.addLayout(config_row)
        ...
        values_row.addWidget(QLabel("电压"))
        values_row.addWidget(self.battery_voltage_input)
        values_row.addWidget(QLabel("电流"))
        values_row.addWidget(self.battery_current_input)
        values_row.addWidget(QLabel("容量/SOC"))
        values_row.addWidget(self.battery_capacity_input)
        battery_grid.addLayout(values_row, 2, 0, 1, 2)
        ...
        battery_grid.addLayout(battery_actions, 3, 0, 1, 2)
        ...
        light_grid.addWidget(QLabel("模式"), 0, 4)
        light_grid.addWidget(self.light_mode_input, 0, 5)
        light_grid.addWidget(QLabel("颜色"), 1, 0)
        light_grid.addWidget(self.light_color_input, 1, 1)
        light_grid.addWidget(QLabel("次数"), 1, 2)
        light_grid.addWidget(self.light_count_input, 1, 3)
        light_grid.addWidget(QLabel("周期"), 1, 4)
        light_grid.addWidget(self.light_cycle_input, 1, 5)
        ...
        light_grid.addLayout(light_actions, 2, 0, 1, 6)
        light_grid.setColumnStretch(3, 1)
        light_grid.setColumnStretch(5, 1)
        light_card = self._card("Orin 灯控模拟", light_grid)

        controls = QHBoxLayout()
        controls.setContentsMargins(0, 0, 0, 0)
        controls.setSpacing(14)
        controls.addWidget(battery_card, 4)
        controls.addWidget(light_card, 7)
        ...
        toolbar.addWidget(self.direction_input)
        toolbar.addWidget(self.apply_filter_button)
        toolbar.addWidget(self.parse_input)
        toolbar.addWidget(self.parse_status)
        toolbar.addStretch(1)
        toolbar.addWidget(self.frame_status)
        ...
        self.frame_table.setMinimumHeight(240)
